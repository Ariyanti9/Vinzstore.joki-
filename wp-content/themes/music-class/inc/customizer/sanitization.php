 ...
 */
function musicclass_sanitize_checkbox( $checked ) {
	// Boolean check.
...
function musicclass_switch_sanitization( $input ) {
    if ( true === $input ) {
        return 1;
    } else {
        return 0;
...
function musicclass_sanitize_choices( $input, $setting ) {
    global $wp_customize; 
...
function musicclass_sanitize_float( $input ) {
 ...
 */
function musicclass_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function musicclass_sanitize_html( $html ) {
 ...
 */
function musicclass_sanitize_image( $image, $setting ) {
 ...
 */
function musicclass_sanitize_nohtml( $nohtml ) {
 ...
 */
function musicclass_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function musicclass_sanitize_range_value( $number, $setting ) {
 ...
 */
function musicclass_sanitize_select( $input, $setting ) {
 ...
 */
function musicclass_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function musicclass_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function musicclass_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}
